...
<template>
  <div class="flex flex-col px-2 w-80 h-96 bg-white rounded-xl drop-shadow-xl mt-[20vh]">
    ...
    <h2 class="text-3xl text-center font-bold pb-5 pt-4">Use your API key</h2>
    <input
      type="password"
      v-model="input"
      placeholder="API KEY"
      class="border-2 border-dashed hover:border-solid focus:outline-emerald-500 border-emerald-300 rounded-full px-4 py-2 my-5 mx-4"
    />
    <button
      @click="saveKey"
